...
create table :results.one_way_relationships as
  ...
  join (
      ...
      from cdm2.relationship r1
      left join cdm2.relationship r2 on r1.relationship_id = r2.reverse_relationship_id or  r2.relationship_id = r1.reverse_relationship_id
      where
