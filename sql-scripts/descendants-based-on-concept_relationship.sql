...
create table :results.one_way_relationships as
  ...
  join (
      select r1.relationship_id rid_1, 
              r1.reverse_relationship_id rrid_1, 
              r2.relationship_id rid_2,
              r2.reverse_relationship_id rrid_2,
              ...
              */
              case 
                    when r1.defines_ancestry::integer + r1.is_hierarchical::integer > r2.defines_ancestry::integer + r2.is_hierarchical::integer then r1.relationship_id
                    when r1.defines_ancestry::integer + r1.is_hierarchical::integer < r2.defines_ancestry::integer + r2.is_hierarchical::integer then r2.relationship_id
                    when r1.relationship_id like '%to%' and r2.relationship_id like '%from%' then r1.relationship_id
                    when r1.relationship_id like '%from%' and r2.relationship_id like '%to%' then r2.relationship_id
                    when r1.relationship_id < r2.relationship_id then r1.relationship_id
                    when r2.relationship_id < r1.relationship_id then r2.relationship_id
              end as relationship_id,
              /*
              case 
                    when r1.defines_ancestry::integer + r1.is_hierarchical::integer > r2.defines_ancestry::integer + r2.is_hierarchical::integer then 'r1'
                    when r1.relationship_id like '%to%' and r2.relationship_id like '%from%' then 'r1'
                    when r1.defines_ancestry::integer + r1.is_hierarchical::integer = r2.defines_ancestry::integer + r2.is_hierarchical::integer then 'r1'
                    else 'r2'
              end as from_which,
              */
