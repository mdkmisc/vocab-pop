...
0) This is a revised copy of Lee's OMOP CDM vocabulary load - PostgreSQL.sql script. 
   You should be able to run this without modification using psql. 
   Well, at least I'm using it that way in https://github.com/Sigfried/vocab-pop
...
\set f '\'' :vocdir '/RELATIONSHIP.csv\''
\set tbl :schema.RELATIONSHIP
\echo loading :f to :tbl
TRUNCATE TABLE :tbl;
COPY :tbl FROM :f WITH DELIMITER E'\t' CSV HEADER QUOTE E'\b' ;
